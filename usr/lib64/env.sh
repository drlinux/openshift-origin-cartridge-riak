...
RUNNER_SCRIPT_DIR=$OPENSHIFT_RIAK_DIR/usr/sbin
RUNNER_SCRIPT=${0##*/}

RUNNER_BASE_DIR=$OPENSHIFT_RIAK_DIR/usr/lib64
RUNNER_ETC_DIR=$OPENSHIFT_RIAK_DIR/etc
RUNNER_LOG_DIR=$OPENSHIFT_RIAK_DIR/log
RUNNER_LIB_DIR=$OPENSHIFT_RIAK_DIR/usr/lib64
RUNNER_PATCH_DIR=$OPENSHIFT_RIAK_DIR/usr/lib64/basho-patches
PIPE_DIR=$OPENSHIFT_RIAK_DIR/var/run
RUNNER_USER=$(whoami)
APP_VERSION=1.4.1
...
RUN_DIR="$OPENSHIFT_RIAK_DIR/run" # for now hard coded unless we find a platform that differs
